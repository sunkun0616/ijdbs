...
'cookie_pre' => 'LsdOf_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
'cookie_ttl' => 0, //Cookie 生命周期，0 表示随浏览器进程
//模板相关配置
'tpl_root' => 'templates/', //模板保存物理路径
'tpl_name' => 'ijdbs', //当前模板方案目录
'tpl_css' => 'ijdbs', //当前样式目录
'tpl_referesh' => 1,
//项目上线后需要修改为0
...
'upload_url' => 'http://www.ijdbs.com/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://www.ijdbs.com/statics/js/', //CDN JS
'css_path' => 'http://www.ijdbs.com/statics/css/', //CDN CSS
'img_path' => 'http://www.ijdbs.com/statics/images/', //CDN img
'app_path' => 'http://www.ijdbs.com/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'X1cznrK0RI2tQWxrT9tk', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://www.ijdbs.com/phpsso_server/',	//接口地址
'phpsso_auth_key' => 'w1z82wil4zoug0thpbc0l0yrww5pdfl2', //加密密钥
