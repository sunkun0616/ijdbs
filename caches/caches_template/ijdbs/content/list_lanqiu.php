		...
		var lanren = {
			...
			loadMore:function(){
				...
				for(var i =0;i<lanren._loading;i++){
					...
					if(!target){
						$('.fengmianliebiao .more').html("<p>已经到底了...</p>");
						break;
					}
