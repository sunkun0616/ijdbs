<?php return array (
  ...
  'author' => 'sk',
  'dirname' => 'ijdbs',
  'homepage' => 'http://www.ijdbs.com',
  'version' => '2.0',
  'disable' => 0,
  'file_explan' => 
  array (
    'templates|ijdbs|content' => 
    array (
      'category.html' => '文章频道页',
      'category_ad.html' => '首页焦点图频道页',
      'category_download.html' => '下载频道页',
      'category_notice.html' => '公告频道页',
      'category_picture.html' => '图片频道页',
      'category_pro.html' => '产品模型频道页',
      'category_video.html' => '',
      'download.html' => '下载连接页',
      'footer.html' => '底部',
      'header.html' => '顶部',
      ...
      'index.html' => '网站首页',
      'list.html' => '列表页',
      'list_ad.html' => '首页焦点图列表页',
      'list_download.html' => '下载列表页',
      'list_notice.html' => '公告列表页',
      ...
      'search.html' => '搜索',
      'show.html' => '文章内容页',
      'show_ad.html' => '首页焦点图内容页',
      'show_download.html' => '下载内容页',
      'show_notice.html' => '公告内容页',
    ...
    'templates|ijdbs|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|ijdbs|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|ijdbs|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|ijdbs|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|ijdbs|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|ijdbs|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|ijdbs|yp' => 
    ...
    'templates|ijdbs|yp|com_ijdbs' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|ijdbs|comment' => 
    array (
